...
const patterns = source.slice(source.indexOf('// ./scripts/leetcode/patterns.js') + '// ./scripts/leetcode/patterns.js'.length, source.indexOf('// ./scripts/leetcode/leetcode.js'));
const context = {};
...
assert.equal(context.getPatternFolder([{ slug: 'design' }, { slug: 'hash-table' }], 'encode-and-decode-tinyurl'), 'Hash Tables');
...
assert.equal(context.organizerClassify([{ slug: 'design' }, { slug: 'hash-table' }], 'encode-and-decode-tinyurl'), 'Hash Tables');
